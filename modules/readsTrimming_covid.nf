process readsTrimming_trimgalore {
    /**
    ...
    */
    ...
    //container "/home/centos/illumina_covid/containers/readsTrimming_trimgalore.simg"
    ...
    if [[ \$(zcat ${forward} | head -n4 | wc -l) -eq 0 ]]; then
      ...
      trim_galore --fastqc --nextera --paired $forward $reverse
    fi
    """
}
