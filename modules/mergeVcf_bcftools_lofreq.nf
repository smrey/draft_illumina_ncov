process mergeVcf_bcftools_lofreq {
    /**
    ...
    */
    ...
    output:
        tuple dataset_id, path("${dataset_id}.lofreqfiltered.combined.vcf"), emit: lofreq_merged_vcf
    ...
    | bcftools sort - > ${dataset_id}.lofreqfiltered.combined.vcf
    """
}
